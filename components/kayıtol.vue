...
<div class="kayıtol-card">
        ...
        <div class="kayıtol-şifre">
          <input v-model="password" placeholder="*Şifre " type="password" required />
        </div>
...
console.log(this.authuser);
  ...
  mounted() {
      ...
      recaptchaScript.setAttribute('src', 'https://www.gstatic.com/firebasejs/8.2.1/firebase-app.js')
